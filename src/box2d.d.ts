...
export const b2DefaultFilter: any;
export const b2Shape_SetCircle: any;
export const b2Shape_SetFilter: any;
...
export const b2Shape_EnableContactEvents: any;
export const b2Body_SetAwake: any;
...
export const b2World_GetContactEvents: any;
